//
//  TestKMGestureRecognizerViewController.m
//  FrameworksTest
//
...
@interface TestKMGestureRecognizerViewController ()
...
@implementation TestKMGestureRecognizerViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.view.backgroundColor = [UIColor whiteColor];
    self.navigationItem.title = @"自定义手势";
    [self layoutUI];
}
...
- (void)handleSwipe:(UISwipeGestureRecognizer *)recognizer {
    ...
    void (^positionOperation)(void) = ^() {
        ...
        newPoint.y -= 20.0;
        weekSelf.imgV.center = newPoint;

        newPoint.y += 40.0;
        weekSelf.imgV2.center = newPoint;
    };
...
- (void)layoutUI {
    ...
    //图片视图 _imgV2
    img = [UIImage imageNamed:@"pl_user_avatar"];

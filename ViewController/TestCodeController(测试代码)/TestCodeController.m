...
@interface TestCodeController ()<AVAssetResourceLoaderDelegate>{
    UIActivityIndicatorView *_indicator;
}

@property (nonatomic, strong) AVPlayer *player;
@property (nonatomic, strong) TestArchiverModel *user;
...
- (void)testCode{
    ...
    //_indicator.transform = CGAffineTransformMakeScale(1.0,1.0) ;
        //设置显示位置
       // _indicator.center = button.center;
        //将这个控件加到父容器中。
    [button addSubview:_indicator];
...
- (void)testPlayer {
    AVURLAsset *urlAsset = (AVURLAsset *)[AVAsset assetWithURL:[NSURL URLWithString:@"http://em.sycdn.kuwo.cn/b97040c577cfa8b5eac03eb301a0b535/63a98869/resource/n3/30/66/2205407643.mp3"]];

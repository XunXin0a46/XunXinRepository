...
- (void)viewDidLoad {
    ...
    //底部为弧线的背景视图
    DXRadianLayerView *view = [[DXRadianLayerView alloc]initWithFrame:CGRectMake(0, navigationBarHeight, SCREEN_WIDTH, 575)];
    view.radian = 10.0;
...
- (void)createUI{
    //控制器名称数组(与下面按钮相对应)
    self.controllerNameAry = @[@"SwipeViewController",@"TestCollectionViewController",@"BaseWebViewControlle",@"TestButtonController",@"YYImageExample",@"TestCodeController",@"SignInController",@"ShadowViewController",@"TestTableViewController",@"TestTableViewDetelateCellController",@"TestRunTimeViewController",@"BezierPathController",@"ScanViewController",@"TestViewController",@"TestNavigationController",@"TestBaiDuRESTController",@"TestUITextViewController",@"TestCALayerController",@"TestCGGeometryController",@"TestCLLocationController",@"TextUIScrollViewController",@"TestRegularViewController",@"TestTTTAttributedLabelViewController",@"TestYBPopupMenuViewController",@"TestUIViewViewController",@"GestureRecognizerViewController",@"BarcodeAndQrCodeViewController",@"TableViewNestingCollectionViewController",@"TransmitValueTestLoginController",@"TestXIBViewConreoller",@"TestCountDownViewController",@"TestPickerViewController",@"NewGrouptheSeventhEveningOfTheSeventhMoonViewController"];
    //按钮标题数组
    NSArray *buttonTilteAry = @[@"滑动视图",@"集合视图",@"WKWebView",@"测试按钮",@"YYWebImage",@"测试代码",@"签到",@"阴影视图",@"下拉选",@"表视图",@"RunTime",@"贝塞尔",@"扫码",@"视图控制器",@"导航栏",@"百度REST",@"文本视图",@"CALayer",@"CGGeometry",@"CLLocation",@"滚动视图",@"测试正则",@"富文本标签",@"弹出菜单",@"测试视图",@"手势识别",@"条形二维码",@"表嵌集",@"传值练习",@"XIB测试",@"倒计时",@"时间选取",@"七夕"];
    //按钮对象数组
